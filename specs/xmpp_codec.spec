...
-xml(group_chat_query,
	   ...
	   module = 'mix_group_chat',
           result = {group_query,'$status','$type','$msgid','$admin_user','$action', '$channel_id', '$group_id','$ptt_status','$removeduser', '$message_id', '$subscriptions','$participants','$result_type','$_els'},
                     attrs = [#attr{name = <<"status">>,default = <<"">>},
                              ...
                              #attr{name = <<"message_id">>,default = <<"">>},
                              #attr{name = <<"channel_id">>,default = <<"">>},
                              #attr{name = <<"action">>,default = <<"">>},
...
-xml(media_call_activities,
	   ...
	   module = 'media_call_activities',
           ...
           '$call_from','$call_time','$call_type','$end_time' ,'$room_id','$group_id','$media_call_type','$call_kind', '$call_link','$caller_name','$meta_data', '$result_type'
           ,'$_els'},
                     attrs = [#attr{name = <<"type">>,default = <<"">>},
                              ...
                              #attr{name = <<"media_call_type">>,default = <<"">>},
                              #attr{name = <<"call_kind">>,default = <<"">>},
                              #attr{name = <<"status">>,default = <<"">>}],
                       cdata = #cdata{default = <<"">>, label = '$result_type'}}).
...
-xml(user_activities,
	   ...
	   module = 'user_activities',
           result = {user_activities, '$remove_user', '$device_id', '$vote_id', '$edit_message_id', '$type', '$id', '$send_seen', '$license_data', '$result_type','$status','$password','$user_id',
           '$socket_id','$message_from','$message_to','$to_user', '$from_user', '$mode', '$send_to', '$poll_option_id', '$voter_user_id', '$poll_id', '$send_from', '$message_type','$message_id','$message_ids','$message','$chat_type','$reply_id','$delete_type','$favourite','$_els','$position','$limit','$row_id','$updated_at',
           '$call_status','$call_type','$caller_device','$call_id','$call_attend_status', '$last_msg_id', '$get_msg_info', '$remove_message_user', '$calllog_ids', '$mute_status','$archive_status','$group_id','$archive','$block_status','$permission_status','$meta_data', '$topic_id', '$topic_time', '$user_list', '$action', '$mute_setting', '$busy_message', '$busy_status', '$busy',
           '$chat_id', '$disappear_time', '$enabled'},
                     attrs = [#attr{name = <<"remove_user">>,default = <<"">>},
                              ...
                              #attr{name = <<"user_list">>,default = <<"">>},
                              #attr{name = <<"action">>,default = <<"">>},
                              #attr{name = <<"mute_setting">>,default = <<"">>},
                              #attr{name = <<"get_msg_info">>,default = <<"">>},
                              #attr{name = <<"busy_message">>,default = <<"">>},
                              #attr{name = <<"busy_status">>,default = <<"">>},
                              #attr{name = <<"busy">>,default = <<"">>},
                              #attr{name = <<"chat_id">>, default = <<"">>},
                              #attr{name = <<"user_id">>, default = <<"">>},
                              #attr{name = <<"disappear_time">>, default = <<"">>},
                              #attr{name = <<"enabled">>, default = <<"">>}],
                       cdata = #cdata{default = <<"">>, label = '$result_type'}}).
...
-xml(mediacall,
           ...
           xmlns = <<"urn:xmpp:call">>,
	   module = 'call',
           result = {mediacall, '$call_mode', '$call_time','$call_status','$call_from','$call_type', '$media_call_type', '$meta_data', '$room_id','$group_id','$call_link','$caller_name'},
...
-xml(chatcontent,
	   ...
	   module = 'chatcontent',
           result = {chatcontent, '$block_user',  '$message_type','$topic_id','$meta_data', '$edit_msg_id', '$disappear_time', '$view_once','$mention_list', '$scheduled_datetime'},
           attrs = [#attr{name = <<"block_user">>,default = <<"0">>},
                    ...
                    #attr{name = <<"disappear_time">>,default = <<"">>},
                    #attr{name = <<"view_once">>,default = <<"">>},
                    #attr{name = <<"mention_list">>,default = <<"">>},
...
-xml(delivered,
	   ...
	   module = 'delivered',
           result = {delivered, '$id', '$message_status', '$group_id','$time'},
...
-xml(seen,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'seen',
           result = {seen, '$id', '$message_status', '$group_id','$time'},
           attrs = [#attr{name = <<"id">>,default = <<"">>},
                    #attr{name = <<"message_status">>,default = <<"">>},
                    #attr{name = <<"group_id">>,default = <<"">>},
                    #attr{name = <<"time">>,default = <<"">>}]}).
...
-xml(view,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'view',
           result = {view, '$id', '$message_status', '$group_id','$time'},
           attrs = [#attr{name = <<"id">>,default = <<"">>},
                    #attr{name = <<"message_status">>,default = <<"">>},
                    #attr{name = <<"group_id">>,default = <<"">>},
                    #attr{name = <<"time">>,default = <<"">>}]}).
...
-xml(poll,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'poll',
           result = {poll, '$poll_id', '$voter_user_id', '$vote_id', '$status', '$chat_type', '$poll_option_id', '$to_user'},
...
-xml(logout,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'logout',
           result = {logout, '$type','$socket_id','$username'},
           attrs = [#attr{name = <<"type">>,default = <<"">>},#attr{name = <<"socket_id">>,default = <<"">>},#attr{name = <<"username">>,default = <<"">>}]}).

-xml(recall,
     #elem{name = <<"recall">>,
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'recall',
           result = {recall, '$id','$chat_type', '$group_id','$time'},
           attrs = [#attr{name = <<"id">>,default = <<"">>},
                    #attr{name = <<"chat_type">>,default = <<"">>},
                    #attr{name = <<"group_id">>,default = <<"">>},
                    #attr{name = <<"time">>,default = <<"">>}]}).
...
-xml(disappear,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'disappear',
           result = {disappear, '$type', '$action','$disappear_time', '$chat_type','$chat_id'},
           attrs = [#attr{name = <<"type">>,default = <<"">>},
                    #attr{name = <<"action">>,default = <<"">>},
                    #attr{name = <<"disappear_time">>,default = <<"">>},
                    #attr{name = <<"chat_type">>,default = <<"">>},
...
-xml(mute,
           ...
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'mute',
           result = {mute, '$type', '$action','$mute_setting', '$user_list'},
           attrs = [#attr{name = <<"type">>,default = <<"">>},
                    #attr{name = <<"action">>,default = <<"">>},
                    #attr{name = <<"mute_setting">>,default = <<"">>},
                    #attr{name = <<"user_list">>,default = <<"">>}]}).
...
-xml(timestamp,
	   ...
	   module = 'timestamp',
           result = {timestampmsg, '$id', '$time','$disappear_time'},
           attrs = [#attr{name = <<"id">>,default = <<"">>},
                    #attr{name = <<"time">>,default = <<"">>},
                    #attr{name = <<"disappear_time">>,default = <<"0">>}]}).

-xml(acknowledge,
     #elem{name = <<"acknowledge">>,
           xmlns = <<"urn:xmpp:receipts">>,
	   module = 'acknowledge',
           result = {acknowledge,  '$type','$id','$sent_to','$group_id', '$disappear_time'},
           attrs = [#attr{name = <<"id">>,default = <<"">>},
...
-xml(vcard_history,
           ...
           xmlns = <<"vcard-temp">>,
	   module = 'xep0054',
          result = {vcard_history, '$vcard_history'},
              cdata = #cdata{default = <<"">>, label = '$vcard_history'}}).
...
-xml(vcard_temp,
	   ...
	   module = 'xep0054',
           result = {vcard_temp, '$version', '$fn', '$n', '$nickname', '$photo',
                     ...
                     '$vcard_emailid','$vcard_nickName','$vcard_history',
           ...
           refs = [#ref{name = vcard_N, min = 0, max = 1, label = '$n'},
                   ...
                   #ref{name = vcard_history, min = 0, max = 1, label = '$vcard_history'},
